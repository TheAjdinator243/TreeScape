...
export async function Hero({ fromCents, symbol }: { fromCents: number; symbol: string }) {
  ...
  return (
    ...
    >
      ...
      */}
      <div className="absolute inset-0 bg-coal-950/25" aria-hidden="true" />
      <div
        className="absolute inset-x-0 bottom-0 h-3/4 bg-gradient-to-t from-coal-950 via-coal-950/65 to-transparent"
        aria-hidden="true"
      />
      ...
      <div className="relative z-[2] mx-auto w-full max-w-6xl px-5 pb-12 pt-32 sm:px-8 md:pb-16">
        <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,1fr)_auto]">
          <div>
            ...
            <p
              className="animate-fade-rise mt-7 max-w-md text-lg leading-relaxed text-cream-100"
