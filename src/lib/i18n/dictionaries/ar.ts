...
export const ar: Dictionary = {
  ...
  video: {
    label: 'تصوير بالطائرة المسيّرة',
    heading: 'المنظر من الأعلى',
    lead: 'المنزل والمسبح والغابة من حولهما — كما تُرى من الجو، في لقطة واحدة.',
    play: 'شغّل الفيديو',
    describe: 'تصوير بالطائرة المسيّرة: المنزل بمسبحه وشرفته، تحيط به الغابة، بإطلالة على الوادي.',
  },
